...
class SettingsWindow(Ui_SettingsWindow, QDialog):
    ...
    def setup(self):
        ...
        self.ApiPort.setValidator(QIntValidator(1, 65535))
    ...
    def ok(self):
        ...
        self.config.smartvista.api_port = self.ApiPort.text()
        self.config.terminal.process_default_dump = self.ProcessDefaultDump.isChecked()
        self.config.terminal.run_api = self.RunApi.isChecked()
