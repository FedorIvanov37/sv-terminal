...
class Ui_SpecificationWindow(object):
    def setupUi(self, SpecificationWindow):
        ...
        spacerItem = QtWidgets.QSpacerItem(1164, 20, QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Minimum)
        self.gridLayout.addItem(spacerItem, 0, 1, 1, 1)
        self.horizontalLayout_3 = QtWidgets.QHBoxLayout()
        self.horizontalLayout_3.setObjectName("horizontalLayout_3")
        self.label = QtWidgets.QLabel(SpecificationWindow)
        self.label.setObjectName("label")
        self.horizontalLayout_3.addWidget(self.label)
        self.StatusLabel = QtWidgets.QLabel(SpecificationWindow)
        self.StatusLabel.setTextInteractionFlags(QtCore.Qt.LinksAccessibleByMouse|QtCore.Qt.TextSelectableByKeyboard|QtCore.Qt.TextSelectableByMouse)
        self.StatusLabel.setObjectName("StatusLabel")
        self.horizontalLayout_3.addWidget(self.StatusLabel)
        self.gridLayout.addLayout(self.horizontalLayout_3, 0, 0, 1, 1)
        self.CheckBoxHideReverved = QtWidgets.QCheckBox(SpecificationWindow)
        ...
        self.SpecTree = QtWidgets.QTreeWidget(SpecificationWindow)
        ...
        self.SpecTree.viewport().setProperty("cursor", QtGui.QCursor(QtCore.Qt.ArrowCursor))
        self.SpecTree.setFocusPolicy(QtCore.Qt.StrongFocus)
...
"")
        self.SpecTree.setInputMethodHints(QtCore.Qt.ImhNone)
        self.SpecTree.setEditTriggers(QtWidgets.QAbstractItemView.NoEditTriggers)
        ...
        self.SpecTree.setSelectionMode(QtWidgets.QAbstractItemView.SingleSelection)
        self.SpecTree.setSelectionBehavior(QtWidgets.QAbstractItemView.SelectRows)
        ...
        self.ButtonSetMti = QtWidgets.QPushButton(SpecificationWindow)
        self.ButtonSetMti.setFocusPolicy(QtCore.Qt.NoFocus)
        self.ButtonSetMti.setObjectName("ButtonSetMti")
        self.horizontalLayout_2.addWidget(self.ButtonSetMti)
        self.ButtonApply = QtWidgets.QPushButton(SpecificationWindow)
        self.ButtonApply.setFocusPolicy(QtCore.Qt.NoFocus)
        self.ButtonApply.setObjectName("ButtonApply")
        self.horizontalLayout_2.addWidget(self.ButtonApply)
        self.ButtonReset = QtWidgets.QPushButton(SpecificationWindow)
        self.ButtonReset.setFocusPolicy(QtCore.Qt.NoFocus)
        self.ButtonReset.setObjectName("ButtonReset")
        self.horizontalLayout_2.addWidget(self.ButtonReset)
        self.ButtonBackup = QtWidgets.QPushButton(SpecificationWindow)
        self.ButtonBackup.setFocusPolicy(QtCore.Qt.NoFocus)
        self.ButtonBackup.setObjectName("ButtonBackup")
        self.horizontalLayout_2.addWidget(self.ButtonBackup)
        self.ParseFile = QtWidgets.QPushButton(SpecificationWindow)
        self.ParseFile.setFocusPolicy(QtCore.Qt.NoFocus)
        self.ParseFile.setObjectName("ParseFile")
        self.horizontalLayout_2.addWidget(self.ParseFile)
        self.ButtonClean = QtWidgets.QPushButton(SpecificationWindow)
        self.ButtonClean.setFocusPolicy(QtCore.Qt.NoFocus)
        self.ButtonClean.setObjectName("ButtonClean")
        self.horizontalLayout_2.addWidget(self.ButtonClean)
        self.ButtonClose = QtWidgets.QPushButton(SpecificationWindow)
        ...
        self.CheckBoxReadOnly = QtWidgets.QCheckBox(SpecificationWindow)
