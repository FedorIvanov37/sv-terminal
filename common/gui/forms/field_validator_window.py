...
class Ui_FieldDataSet(object):
    def setupUi(self, FieldDataSet):
        ...
        FieldDataSet.setMinimumSize(QtCore.QSize(505, 700))
        FieldDataSet.setMaximumSize(QtCore.QSize(505, 700))
        ...
        self.gridLayout.addLayout(self.CheckTypeLayout, 0, 0, 1, 3)
        ...
        self.gridLayout.addWidget(self.ValuesList, 1, 0, 1, 3)
        ...
        self.gridLayout.addWidget(self.PlusButton, 2, 0, 1, 1)
        self.MinusButton = QtWidgets.QPushButton(parent=self.groupBox_6)
        self.MinusButton.setMaximumSize(QtCore.QSize(30, 30))
        font = QtGui.QFont()
        font.setPointSize(10)
        font.setBold(True)
        font.setWeight(75)
        ...
        self.gridLayout.addWidget(self.MinusButton, 2, 1, 1, 1)
        ...
        FieldDataSet.rejected.connect(FieldDataSet.reject) # type: ignore
    ...
    def retranslateUi(self, FieldDataSet):
        ...
        self.PlusButton.setText(_translate("FieldDataSet", "+"))
        self.MinusButton.setText(_translate("FieldDataSet", "-"))
        self.groupBox_5.setTitle(_translate("FieldDataSet", "Field Type"))
        self.FieldType.setItemText(0, _translate("FieldDataSet", "Not set"))
        self.FieldType.setItemText(1, _translate("FieldDataSet", "Currency"))
        self.FieldType.setItemText(2, _translate("FieldDataSet", "Country"))
        self.FieldType.setItemText(3, _translate("FieldDataSet", "MCC"))
        self.FieldType.setItemText(4, _translate("FieldDataSet", "Date"))
        self.FieldType.setItemText(5, _translate("FieldDataSet", "Other"))
