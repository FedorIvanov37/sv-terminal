...
class Ui_SettingsWindow(object):
    def setupUi(self, SettingsWindow):
        ...
        self.GeneralButtonBox.setStandardButtons(QtWidgets.QDialogButtonBox.StandardButton.Cancel|QtWidgets.QDialogButtonBox.StandardButton.Ok)
        ...
        self.FieldsButtonBox.setStandardButtons(QtWidgets.QDialogButtonBox.StandardButton.Cancel|QtWidgets.QDialogButtonBox.StandardButton.Ok)
        ...
        self.gridLayout_10 = QtWidgets.QGridLayout(self.API)
        self.gridLayout_10.setObjectName("gridLayout_10")
        self.ApiButtonBox = QtWidgets.QDialogButtonBox(parent=self.API)
        self.ApiButtonBox.setStandardButtons(QtWidgets.QDialogButtonBox.StandardButton.Cancel|QtWidgets.QDialogButtonBox.StandardButton.Ok)
        self.ApiButtonBox.setObjectName("ApiButtonBox")
        self.gridLayout_10.addWidget(self.ApiButtonBox, 3, 0, 1, 1)
        ...
        self.IpLabel_2 = QtWidgets.QLabel(parent=self.ApiBox)
        self.IpLabel_2.setObjectName("IpLabel_2")
        self.horizontalLayout_12.addWidget(self.IpLabel_2)
        self.ApiAddress = QtWidgets.QLineEdit(parent=self.ApiBox)
        self.ApiAddress.setObjectName("ApiAddress")
        self.horizontalLayout_12.addWidget(self.ApiAddress)
        self.PortLabel_2 = QtWidgets.QLabel(parent=self.ApiBox)
        self.PortLabel_2.setObjectName("PortLabel_2")
        self.horizontalLayout_12.addWidget(self.PortLabel_2)
        self.ApiPort = QtWidgets.QSpinBox(parent=self.ApiBox)
        self.ApiPort.setMinimumSize(QtCore.QSize(80, 0))
        self.ApiPort.setFrame(True)
        self.ApiPort.setButtonSymbols(QtWidgets.QAbstractSpinBox.ButtonSymbols.NoButtons)
        self.ApiPort.setKeyboardTracking(False)
        self.ApiPort.setMinimum(1024)
        self.ApiPort.setMaximum(65535)
        self.ApiPort.setProperty("value", 16677)
        self.ApiPort.setObjectName("ApiPort")
        self.horizontalLayout_12.addWidget(self.ApiPort)
        self.gridLayout_9.addLayout(self.horizontalLayout_12, 0, 0, 1, 1)
        self.gridLayout_10.addWidget(self.ApiBox, 0, 0, 1, 1)
        spacerItem6 = QtWidgets.QSpacerItem(20, 303, QtWidgets.QSizePolicy.Policy.Minimum, QtWidgets.QSizePolicy.Policy.Expanding)
        ...
        self.ApiInfoLabel.setTextInteractionFlags(QtCore.Qt.TextInteractionFlag.LinksAccessibleByMouse)
        self.ApiInfoLabel.setObjectName("ApiInfoLabel")
        self.gridLayout_10.addWidget(self.ApiInfoLabel, 1, 0, 1, 1)
        ...
        self.SpecificationButtonBox.setStandardButtons(QtWidgets.QDialogButtonBox.StandardButton.Cancel|QtWidgets.QDialogButtonBox.StandardButton.Ok)
        ...
        self.gridLayout_11.addItem(spacerItem9, 2, 1, 1, 1)
        ...
        spacerItem12 = QtWidgets.QSpacerItem(145, 20, QtWidgets.QSizePolicy.Policy.Expanding, QtWidgets.QSizePolicy.Policy.Minimum)
        self.gridLayout_11.addItem(spacerItem12, 1, 2, 1, 1)
        ...
        spacerItem13 = QtWidgets.QSpacerItem(146, 20, QtWidgets.QSizePolicy.Policy.Expanding, QtWidgets.QSizePolicy.Policy.Minimum)
    ...
    def retranslateUi(self, SettingsWindow):
        ...
        self.IpLabel_2.setText(_translate("SettingsWindow", "IP"))
        self.ApiAddress.setPlaceholderText(_translate("SettingsWindow", "Local API address"))
        self.PortLabel_2.setText(_translate("SettingsWindow", ":"))
        self.ApiPort.setSpecialValueText(_translate("SettingsWindow", "Val"))
